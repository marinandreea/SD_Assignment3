...
public class TestFlow {
  ...
  //  @MockBean
    ...
    public void addNewCashierTest(){
        User user = new User(4,"cashier.3","cashier3", Role.CASHIER);
    ...
    public void createNewCartTest(){
        ...
        Product product1 = new Product(3,"notebook","quality paper",3.5,50,0);
        Product product2 = new Product(4,"bag","pink",50,10,0);
